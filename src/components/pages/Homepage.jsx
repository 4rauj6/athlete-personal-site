    ...
    <div className="bg-gray-50">
      <section className="text-blue-500 ">
        <div>
          ...
          <button className="bg-blue-500 text-white p-1 rounded cursor-pointer">
            Know more
          </button>
        </div>
        ...
        <div className="flex flex-row gap-10 object-cover justify-center items-center">
          <div>
            <Link to="/biografy">
              ...
              >
                ...
                <div
                  className={`flex flex-col bg-blue-500 p-4 transition duration-300 ease-in-out w-full h-30 absolute bottom-0 ${isOnHover === 1 ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
                >
          ...
          <div>
            ...
            >
              ...
              />
              <div
                className={`flex flex-col bg-blue-500 p-4 transition duration-300 ease-in-out w-full h-30 absolute bottom-0 ${isOnHover === 2 ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
              >
                <div className="text-white ">
                  <span className="text-3xl">
          ...
          <div>
            ...
            >
              ...
              />
              <div
                className={`pointer-events-none flex flex-col bg-blue-500 p-4 transition duration-300 ease-in-out w-full h-30 absolute bottom-0 ${isOnHover === 3 ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
              >
                <div className="text-white">
                  <span className="text-3xl">
                  ...
                  <p>
                    Knowing deeply inside of Athlete&apos;s charities collabs
                  </p>
                  <p>
                    <p>Click to know more about it</p>
                  </p>
      ...
      <section className="bg-blue-500  h-250 mt-30">
